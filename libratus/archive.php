			...
			<div class="inner">
				<div class="gallery archive pad">
					...
					<div class="block archive">	
						<h5><i class="fa fa-picture-o fa-fw"></i> <?php echo gettext('Gallery Archive'); ?></h5>
					...
					<div class="block archive">	
						<h5><i class="fa fa-newspaper-o fa-fw"></i> <?php echo gettext('News Archive'); ?></h5>
						<div class="archive-cols">
					...
					<div class="block archive">	
						<h5><i class="fa fa-tags fa-fw"></i> <?php echo gettext('Tags'); ?></h5>
						<div class="archive-cols">
