		<div id="bottom-links" class="clearfix">
			<div class="inner">
<!--JKP-->
    <img style="height: 20px; width: 100%; margin-top: 0.6em; margin-bottom: 0.1em;" alt="gray scale" src="http://beta.jekophoto.eu/gallery/themes/zpbase/images/grayscale.png" id="grayscale">
<!--JKP END-->
			</div>
		</div>
		...
		<div id="bottom-modules" class="wrap clearfix">
			<div style="border-bottom: 1px solid ! important;" class="inner pad">
				<div class="row">
                    ...
                    <div class="inner pad">
                      <div class="row">
                        ...
                        <div class="four columns">
                          <h5><i class="fa fa-user fa-fw"></i> User information</h5>
                          <div>
                            <ul id="latestnews">
...
<li>
<?php if (zp_loggedin()) { ?>
      <i class="fa fa-sign-out fa-fw"></i> <?php printUserLogin_out(''); ?>
<?php } else { ?>
      <i class="fa fa-sign-in fa-fw"></i> <?php printCustomPageURL(gettext('Login'),'login',''); ?>
<?php } ?>
</li>
<?php } ?>			
<?php if (!zp_loggedin() && function_exists('printRegistrationForm')) { ?>
<li>
    <i class="fa fa-key fw"></i> <?php printCustomPageURL(gettext('Register'),'register','',''); ?>
</li>
    <?php } ?>


                              
                              <li><?php if (class_exists('RSS')) { ?>
				...
				<?php } ?></li>
                        ...
                        <div class="four columns">
                          <h5><i class="fa fa-gavel fa-fw"></i> Legal information</h5>
                            <ul id="latestnews">
                              <li><i class="fa fa-info fa-fw"></i> Disclaimer</li>
                              <li><i class="fa fa-info fa-fw"></i> Private Policy</li>
                              <li><i class="fa fa-info fa-fw"></i> Legal Notice</li>
                              <li><i class="fa fa-info fa-fw"></i> Cookies</li>
                            </ul>
                        </div>

                        <div class="four columns">
                          <h5><i class="fa fa-envelope-o fa-fw"></i> Contact information</h5>
                                  <ul id="latestnews">
                              <li><i class="fa fa-envelope-o fa-fw"></i> contact form</li>
                              <li>For detailed information <br>see my Legal Notice.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
...
<!-- JKP -->
                                <div id="copyright"><?php echo "© 2007-" . date("Y") . " " . getOption('libratus_copy'); ?></div>
<!-- JKP END-->
